...
class GeoIp implements JsonSerializable
{
    ...
    public function __construct(
        ...
        $maxMindDomainRaw,
        $maxMindIspRaw,
        ?float $sypexCityLatitude = null,
        ?float $sypexCityLongitude = null,
        ?string $sypexCity = null,
        ?int $sypexCityOkato = null,
        ?bool $sypexCityVk = null,
        ?int $sypexCityPopulation = null,
        ?string $sypexCityTel = null,
        ?string $sypexCityPostalCode = null,
        ?float $sypexRegionLatitude = null,
        ?float $sypexRegionLongitude = null,
        ?string $sypexRegion = null,
        ?string $sypexRegionCode = null,
        ?string $sypexRegionTimezone = null,
        ?int $sypexRegionOkato = null,
        ?string $sypexRegionAuto = null,
        ?bool $sypexRegionVk = null,
        ?float $sypexCountryLatitude = null,
        ?float $sypexCountryLongitude = null,
        ?string $sypexCountry = null,
        ?string $sypexCountryCode = null,
        ?string $sypexCountryContinentCode = null,
        ?string $sypexCountryTimezone = null,
        ?int $sypexCountryArea = null,
        ?int $sypexCountryPopulation = null,
        ?string $sypexCountryCapital = null,
        ?string $sypexCountryCurrencyCode = null,
        ?string $sypexCountryPhoneCode = null,
        ?string $sypexCountryNeighbours = null,
        ?bool $sypexCountryVk = null,
        ?string $maxMindCountryContinentCode = null,
        ?string $maxMindCountryContinent = null,
        ?string $maxMindCountryCountryCode = null,
        ?string $maxMindCountryCountry = null,
        ?string $maxMindCountryRegisteredCountryCode = null,
        ?string $maxMindCountryRegisteredCountry = null,
        ?string $maxMindCityCity = null,
        ?string $maxMindCityContinentCode = null,
        ?string $maxMindCityContinent = null,
        ?string $maxMindCityCountryCode = null,
        ?string $maxMindCityCountry = null,
        ?string $maxMindCityRegisteredCountryCode = null,
        ?string $maxMindCityRegisteredCountry = null,
        ?float $maxMindCityLatitude = null,
        ?float $maxMindCityLongitude = null,
        ?string $maxMindCityLocationAccuracyRadius = null,
        ?string $maxMindCitySubdivision = null,
        ?string $maxMindCityTimeZone = null,
        ?string $maxMindCityPostalCode = null,
        ?string $maxMindDomainDomain = null,
        ?string $maxMindIspAsnNumber = null,
        ?string $maxMindIspAsnOrganization = null,
        ?string $maxMindIspIsp = null,
        ?string $maxMindIspOrganization = null,
    ) {
        $this->ip = $ip;
